...
/**
 * C9 corpus verifier — asserts 100% determinism of c9_oracle.json
 * node fixtures/verify-c9.js
 */
...
const file = path.join(__dirname, 'c9_oracle.json');
...
console.log(`verify-c9: ${count}/${doc.cases.length} cases deterministic, corpus sha256 ${sha.slice(0, 12)}…`);
