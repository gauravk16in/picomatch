...
/**
 * C2 corpus verifier — re-drives every c2 case against the reference and
 * byte-compares. node fixtures/verify-c2.js
 */
...
const corpusPath = path.join(__dirname, 'c2_oracle.json');
...
console.log(`verify-c2: ${pass}/${doc.cases.length} cases deterministic, corpus sha256 ${sha.slice(0, 12)}…`);
