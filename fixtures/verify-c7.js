...
/**
 * C7 corpus verifier — asserts 100% determinism of c7_oracle.json
 * node fixtures/verify-c7.js
 */
...
const file = path.join(__dirname, 'c7_oracle.json');
...
console.log(`verify-c7: ${count}/${doc.cases.length} cases deterministic, corpus sha256 ${sha.slice(0, 12)}…`);
